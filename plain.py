...
class Plain17(tf.keras.Model):
    def __init__(self):
        """
        This model is a plain CNN with 17 layers
        The plain model follows the structure of VGG networks -
        CNNs with 3x3 by filters one after another.
        """
        super(Plain17, self).__init__()
        ...
        self.block_3_4 =tf.keras.layers.Conv2D(256,3,padding="same",activation="relu") #56x56x256
        ...
        self.block_4_4 = tf.keras.layers.Conv2D(512,3,padding="same",activation="relu") #28x28x512
        ...
        #self.block_5_4 =tf.keras.layers.Conv2D(512,3,padding="same",activation="relu") #14x14x512
    ...
    def call(self,images,is_testing=False):
        ...
        block_3_out = self.pool_3(self.bn(self.block_3_4(self.bn(self.block_3_3(self.bn(self.block_3_2(self.bn(self.block_3_1(block_2_out)))))))))
        block_4_out = self.pool_4(self.bn(self.block_4_4(self.bn(self.block_4_3(self.bn(self.block_4_2(self.bn(self.block_4_1(block_3_out)))))))))
        block_5_out = self.pool_5(self.bn(self.block_5_2(self.bn(self.block_5_1(block_4_out)))))
        #block_5_out = self.pool_5(self.bn(self.block_5_4(self.bn(self.block_5_3(self.bn(self.block_5_2(self.bn(self.block_5_1(block_4_out)))))))))
