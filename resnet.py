...
class ResNet17(tf.keras.Model):
    def __init__(self):
        """
        This model is a Residual Neural Network with 17 layers.
...
class ResNet31(tf.keras.Model):
    def __init__(self):
        ...
        #self.res_block_1_4 = ResBlock(64,64)
        #maxpool
        ...
        self.res_block_4_2 = ResBlock(512,512)
        #maxpool
        self.res_block_5_1 = ResBlock(512,512,is_resampled=True)
        self.res_block_5_2 = ResBlock(512,512)
    ...
    def call(self,images,is_testing=False):
        block_1_out = tf.nn.max_pool2d(self.res_block_1_2(self.res_block_1_1(images)),2,2, "VALID")
        block_2_out = self.res_block_2_4(self.res_block_2_3(self.res_block_2_2(self.res_block_2_1(block_1_out))))
        block_2_out_pool = tf.nn.max_pool2d(block_2_out,2,2, "VALID")
        block_3_out = self.res_block_3_4(self.res_block_3_3(self.res_block_3_2(self.res_block_3_1(block_2_out_pool))))
        block_3_out_pool = tf.nn.max_pool2d(block_3_out,2,2, "VALID")
        block_4_out = self.res_block_4_2(self.res_block_4_1(block_3_out_pool))
        block_4_out_pool = tf.nn.max_pool2d(block_4_out,2,2, "VALID")
        block_5_out = self.res_block_5_2(self.res_block_5_1(block_4_out_pool))
        block_5_out_pool = tf.nn.max_pool2d(block_5_out,2,2, "VALID")

        flat_out = self.flat(block_5_out_pool)
        dense_1_out = self.dense_1(flat_out)
        if(is_testing==False):
            dense_1_out = tf.nn.dropout(dense_1_out, 0.3)
        dense_2_out = self.dense_2(dense_1_out)
