...
class  ResNet32(tf.keras.Model):
    def __init__(self):
        ...
        self.res_block_1_1 = ResBlock(3,16,1)
        self.res_block_1_2 = ResBlock(3,16,1)
        self.res_block_1_3 = ResBlock(3,16,1)
        self.res_block_1_4 = ResBlock(3,16,1)
        self.res_block_1_5 = ResBlock(3,16,1)
        #input should be 32*32*16
        self.res_block_2_1 = ResBlock(3,32,2,is_resampled=True)
        self.res_block_2_2 = ResBlock(3,32,1)
        self.res_block_2_3 = ResBlock(3,32,1)
        self.res_block_2_4 = ResBlock(3,32,1)
        self.res_block_2_5 = ResBlock(3,32,1)
        #input should be 16*16*64
        self.res_block_3_1 = ResBlock(3,64,2,is_resampled=True)
        self.res_block_3_2 = ResBlock(3,64,1)
        self.res_block_3_3 = ResBlock(3,64,1)
        self.res_block_3_4 = ResBlock(3,64,1)
        self.res_block_3_5 = ResBlock(3,64,1)
